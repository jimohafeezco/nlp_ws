...
similar_to_stolen = all_prez_embeddings .most_similar("stolen", topn= 20)
# get President Roosevelt sentences

# print(similar_to_stolen)
...
roosevelt_stop = [word for sentence in roosevelt_sentences for word in sentence if word not in stop_words]
most_comm=Counter(roosevelt_stop).most_common()
# print(most_comm)
...
rushmore_prez_sentences= get_presidents_sentences(["washington", "jefferson", "lincoln","odore-roosevelt"])
...
rushmore_similar_to_freedom=rushmore_embeddings.most_similar('freedom')
